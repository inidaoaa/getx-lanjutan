        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              elevation: 5,
              shadowColor: const Color.fromARGB(255, 14, 93, 229).withOpacity(0.5),
              child: ListTile(
                ...
                title: Text(
                  ...
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: const Color.fromARGB(255, 14, 93, 229),
                  ),
                ),
                subtitle: Text(
                  item.slug ?? '',
                ...
                trailing: Row(
                  ...
                  children: [
                    IconButton(
                      icon: Icon(Icons.edit, color: const Color.fromARGB(255, 14, 93, 229)),
                      onPressed: () =>
